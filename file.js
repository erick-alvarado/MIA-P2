...
async function login(email, password, callback) {
  ...
  let sql = "select * from usuario where usuario != 'admin' AND usuario ='"+email+"' AND contrasena = '"+password+"'";
  let result = await Open(sql,[],false).catch((e) => { callback(new Error("my error message"));});
